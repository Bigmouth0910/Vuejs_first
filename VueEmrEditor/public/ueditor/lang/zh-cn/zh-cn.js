UE.I18N["zh-cn"] = {
  ...
  tagimg: {
    static: {
      ...
      lang_input_nextsStep: "下一步",
      lang_input_clear: "清空",
      lang_input_addRect: "添加矩形",
      lang_input_ScalePic: "缩放背景",
      lang_input_addOval: "添加椭圆",
      lang_input_hollowRect: "添加空心矩形",
      lang_input_addTxt: "添加文字",
      lang_input_addArrow: "添加箭头",
      J_imgTxt: { title: "添加背景图片" },
    },
    noScarwl: "尚未作画，白纸一张~",
    scrawlUpLoading: "涂鸦上传中,别急哦~",
  ...
  edittd: {
    static: {
      lang_tdBkColor: "背景颜色:",
      lang_printfalse: "打印不显示",
      lang_borderMap: "单元格边框",
      lang_noneBoder: "无边框",
      lang_topBorder: "上边框",
      lang_bottomBorder: "下边框",
      lang_leftBorder: "左边框",
      lang_rightBorder: "右边框",
    },
  },
  diagonal: {
    static: {
      lang_tdDiagonal: "斜分割线",
    },
  },
  formulas: {
    static: {},
