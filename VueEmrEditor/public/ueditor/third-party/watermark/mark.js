function watermark(settings, bodyDiv) {
  //默认设置
  var defaultSettings = {
    watermark_txt: 'text',
  ...
  //获取页面最大宽度
  var page_width = Math.max(bodyDiv.scrollWidth, bodyDiv.clientWidth)
  var cutWidth = page_width * 0.015
  var page_width = page_width - cutWidth
  //获取页面最大高度
  var page_height = Math.max(bodyDiv.scrollHeight, bodyDiv.clientHeight) + 450
